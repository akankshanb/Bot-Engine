...
We implemented mock services for each use case and data to support service integration. The code for mock data is in, [framework/mocking_agent](https://github.ncsu.edu/csc510-fall2019/CSC510-22/tree/master/plotbot/framework/mocking_agent.py)
For services' integration and end-to-end work-flows, we have mocked up responses to services' requests at following points.
